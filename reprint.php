...
$pdf -> Cell(20,10,ucfirst("$mother_middle_name "),0,0);
...
$pdf -> Cell(30,10," Peter Kanoti",0,0);
...
$pdf -> Cell(80,10," Peter Kanoti",0,0,C);
...
<div class="topnav">
  ...
  <a href="registrar.php">BACK HOME</a>
      ...
      <tr>
      <td>
  <table class="input-group" cellpadding="1px" cellpadding="1px" border="1px" width="500px" style="background-color: white;"   ">

  <thead>CHILD DETAILS</thead>
  <?php
        $email_user = $_SESSION['email_user'];
 $sql = "SELECT * FROM successful_child_details WHERE email = '$email_user'";
$result = mysqli_query($db, $sql);
   while ($row=mysqli_fetch_array($result)) {

 echo "<form action='reprint.php' method='post' target=_blank>";
            
    echo "<tr>";
echo "<th>"."FIRST NAME"." </th>"; 
echo "<td>" . "<input type=text   name=first_name_child readonly value=" .$row['first_name'].">". " </td>"; 
      echo"</tr>";

      echo "<tr>";
 echo "<th>"."MIDDLE NAME"."</th>";     
echo "<td>" . "<input type=text   name=middle_name_child readonly value=" .$row['middle_name'].">". " </td>";
        echo "</tr>";


        echo "<tr>";
 echo "<th>"."GENDER"."</th>";     
echo "<td>"."<input type=text   name=gender readonly value=" .$row['gender'].">"." </td>";
        echo "</tr>";

        echo "<tr>";
 echo "<th>"."DATE OF BIRTH"."</th>";     
echo "<td>"."<input type=text   name=date_of_birth readonly value=" .$row['date_of_birth'].">"." </td>";
        echo "</tr>";
        ...
        echo "<tr>";
 echo "<th>"."LOCATION"."</th>";     
echo "<td>"."<input type=text   name=location readonly value=" .$row['location'].">"." </td>";
        echo "</tr>";
...
echo "<td>"."<input type=text name=father_first_name  readonly value=" .$row['father_first_name'].">"." </td>";
        echo "</tr>";

        echo "<tr>";
 echo "<th>"."MIDDLE NAME OF FATHER"."</th>";     
echo "<td>"."<input type=text   name=father_middle_name readonly value=" .$row['father_middle_name'].">"." </td>";
        echo "</tr>";

        echo "<tr>";
 echo "<th>"."SURNAME OF FATHER"."</th>";     
echo "<td>"."<input type=text name=father_surname  readonly value=" .$row['father_surname'].">"." </td>";
        echo "</tr>";

        echo "<tr>";
 echo "<th>"."FIRST NAME OF MOTHER"."</th>";     
echo "<td>"."<input type=text   name=mother_first_name readonly value=" .$row['mother_first_name'].">"." </td>";
        echo "</tr>";

        echo "<tr>";
 echo "<th>"."MIDDLE NAME OF MOTHER"."</th>";     
echo "<td>"."<input type=text name=mother_middle_name  readonly value=" .$row['mother_middle_name'].">"." </td>";
        echo "</tr>";

        echo "<tr>";
 echo "<th>"."MAIDEN NAME OF MOTHER"."</th>";     
echo "<td>"."<input type=text   name=mother_maiden_name readonly value=" .$row['mother_maiden_name'].">"." </td>";
        echo "</tr>";
  ...
  <?php
        $email_user = $_SESSION['email_user'];
 $sql = "SELECT * FROM successful_applicants WHERE email = '$email_user'";
$result = mysqli_query($db, $sql);
   while ($row=mysqli_fetch_array($result)) {
